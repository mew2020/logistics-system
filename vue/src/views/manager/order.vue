<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 10px;">
      <el-input style="width: 250px; margin-right: 10px;" placeholder="请输入查询的站点名称" v-model="data.name" :prefix-icon="Search"></el-input>
    ...
    <div class="card">
      ...
      <div>
        ...
        <el-table :data="data.tableData" height="395" style="width: 100%">
          ...
          <el-table-column prop="level" label="站点级别" width="180"/>
          <el-table-column prop="location" label="站点地址" width="180"/>
          <el-table-column prop="manager_id" label="站点负责人id" width="180"/>
          <el-table-column prop="manager_name" label="站点负责人" width="180"/>
