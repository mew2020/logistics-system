<template>
  ...
  <el-form :model="data.form" label-width="120px" ref="formRef">
    ...
    <BMap id="bMap" height="50vh" width="50%" :enable-scroll-wheel-zoom="true" :center="location.addr" @click="onMapClick">
      <b-zoom></b-zoom>
      <b-scale></b-scale>
      <b-location></b-location>
      <b-marker :position="location.latlng" id="marker"></b-marker>
    </BMap>
...
import { BMap, usePointGeocoder } from 'vue3-baidu-map-gl';
...
//   })
// }
//const { reverseGeocode } = usePointGeocoder({ map: document.getElementById('bMap') });
...
const onMapClick = (event) => {
  ...
  // reverseGeocode(event.latlng, (result) => {
  //   data.form.location = result.address
  // })
